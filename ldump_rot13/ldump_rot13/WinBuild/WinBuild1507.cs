...
using System.Linq;
using System;
﻿using ldump_rot13.Module;
using System.Runtime.InteropServices;

namespace ldump_rot13.WinBuild
{
    class WinBuild1507 : IWinBuild
    {
        ...
        public WinBuild1507()
        {
            ...
            PrimaryCredentialType = typeof(Msv1.MSV1_0_PRIMARY_CREDENTIAL_10_OLD);
            ...
            KerberosHashType = typeof(Kerberos.KERB_HASHPASSWORD_6);

            build = OSVersionHelper.KULL_M_WIN_BUILD_10_1507;
