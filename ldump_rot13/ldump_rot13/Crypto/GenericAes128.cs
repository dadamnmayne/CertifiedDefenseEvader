...
namespace ldump_rot13.Crypto
{
    class GenericAes128
    {
                    ...
                    if (Natives.CryptSetKeyParam(hKey, KP_MODE, pMode, 0))
                    {
                        if (Natives.CryptSetKeyParam(hKey, KP_IV, pIV, 0))
                        {
                            ...
                            if (pOut != IntPtr.Zero)
                            {
                                ...
                                {
                                    Console.WriteLine(new string("PelcgQrpelcg ".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()) + Marshal.GetLastWin32Error());
                                    dwOutLen = 0;
                                }
                            }
                        }
                        else Console.WriteLine(new string("PelcgFrgXrlCnenz (VI)".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
                    }
                    else Console.WriteLine(new string("PelcgFrgXrlCnenz (ZBQR)".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
                    Natives.CryptDestroyKey(hKey);
                }
                else Console.WriteLine(new string("xhyy_z_pelcgb_uxrl".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
                Natives.CryptReleaseContext(hProv, 0);
            }
            else Console.WriteLine(new string("PelcgNpdhverPbagrkg".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
            return status;
        }
        ...
        private static bool kull_m_crypto_close_hprov_delete_container(IntPtr hProv)
        {
            ...
            if (!status)
                Console.WriteLine(new string("PelcgTrgCebiCnenz/PelcgNpdhverPbagrkgN".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
            return status;
        }
        ...
        private static bool kull_m_crypto_CryptGetProvParam(IntPtr hProv, uint dwParam, bool withError, IntPtr data, ref uint cbData, ref uint simpleDWORD)
        {
            ...
            if (simpleDWORD != 0)
            {
                ...
                else if (withError) Console.WriteLine(new string("PelcgTrgCebiCnenz(fvzcyr QJBEQ)".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
            }
            else
            {
                if (Natives.CryptGetProvParam(hProv, dwParam, IntPtr.Zero, ref dwSizeNeeded, 0))
                {
                    ...
                    if (data != IntPtr.Zero)
                    {
                        ...
                        {
                            if (withError)
                                Console.WriteLine(new string("PelcgTrgCebiCnenz(qngn)".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
                            Marshal.FreeHGlobal(data);
                        }
                    }
                }
                else if (withError) Console.WriteLine(new string("PelcgTrgCebiCnenz(vavg)".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
            }
            return status;
        }
    }
